...
hexo.extend.filter.register('after_generate', function (locals) {
  ...
  // 集体声明配置项
    const card_data = {
      ...
      card_css: config.card_css ? urlFor(config.card_css) : 'https://npm.elemecdn.com/hexo-butterfly-artitalk-pro/lib/card.css',
      card_visual_js: config.card_visual_js ? urlFor(config.card_visual_js) : 'https://npm.elemecdn.com/hexo-butterfly-artitalk-pro/lib/card_visual.js'
    }
  // 渲染页面
